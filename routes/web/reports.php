...
Route::get( '/reports/products-thermal-80mm', [ ReportsController::class, 'productsThermal80mmReport' ] )->name( ns()->routeName( 'ns.dashboard.reports.products-thermal-80mm' ) );
